...
mkdir -p dist/refquant_gui_installer_linux/usr/local/bin
mv dist/refquant dist/refquant_gui_installer_linux/usr/local/bin/refquant
mkdir dist/refquant_gui_installer_linux/DEBIAN
cp control dist/refquant_gui_installer_linux/DEBIAN
dpkg-deb --build --root-owner-group dist/refquant_gui_installer_linux/
